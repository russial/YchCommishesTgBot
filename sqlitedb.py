...
class YchDb:
    ...
    """
    __add_new_query='INSERT OR REPLACE INTO ychs (chatid, ychid, maxprice, endtime, link) VALUES (?,?,?,?,?)'
    ...
    def __init__(self, path):
        ...
        # TODO: Find out, if there's need to check_same_thread=False directive
        self.__init_db()
